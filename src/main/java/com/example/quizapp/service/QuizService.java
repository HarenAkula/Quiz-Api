...
public class QuizService {
	...
	/**
	 * Service function to create a quiz on client request
	...
	/**
	 * Service function to send the list of quiz questions on client request
	...
	/**
	 * Service function to calculate quiz score
	 ...
	 */
	public ResponseEntity<Integer> calculateResult(Integer id, List<QuizResponses> quizResponses) {
		Quiz quiz = quizDao.findById(id).get();
		List<Question> questions = quiz.getQuestions();
		int right = 0;
		int i = 0;
		for (QuizResponses response : quizResponses) {
